const phimList = [
    ...
    },
    {
        ...
        // },
        daodien: "Lý Hải",
        dienvien: "NSUT Kim Phương, NSUT Tuyết Thu, Quách Ngọc Tuyên, Đoàn Thế Vinh, ...",
        mota: "Lật Mặt 8: Vòng Tay Nắng kể về sự khác biệt quan điểm giữa ba thế hệ ông bà cha mẹ con cháu. Ai cũng đúng ở góc nhìn của mình nhưng đứng trước hoài bão của tuổi trẻ, cuối cùng thì ai sẽ là người phải nghe theo người còn lại? Và nếu ước mơ của những đứa trẻ bị cho là viển vông, thì cơ hội nào và bao giờ tuổi trẻ mới được tự quyết định tương lai của mình?"
    },
    {
        id: "p04",
        ten: "Thám tử Kiên: Kỳ án không đầu",
        anh: "images/tham-tu-kien.jpg",
    ...
    },
    {
        ...
        // },
        daodien: "Lim Dae Hee",
        dienvien: "Ma Dong Seok, Seohyun (SNSD), David Lee, ...",
        mota: "Bộ phim xoay quanh 'Holy Night', một bộ ba thợ săn quỷ gồm Bau (Ma Dong-seok), Sharon (Seohyun) và Kim Gun (David Lee) được trang bị sức mạnh siêu nhiên, những người được gọi đến để cứu Seoul khi thành phố này rơi vào hỗn loạn khi một mạng lưới tội phạm thờ quỷ xuất hiện. "
    },
    {
        id: "p06",
        ten: "Shin cậu bé bút chì: Bí ẩn! Học viện hoa lệ Tenkasu",
        anh: "images/shin.jpg",
        theloai: "Hoạt hình",
        thoiluong: "106 phút",
        // lichChieu: {
    ...
    },
    {
        ...
        //     "12-05-2025": ["11:00", "16:00"],
        // },
        daodien: "Ricardo Curtis, Rodrigo Perez-Castro",
        dienvien: "Davis Harbour, Bryn McAuley, Paul Sun Hyung Lee, ...",
        mota: "Night Of The Zoopocalypse/ Quái Thú Đại Náo Sở Thú xảy ra khi một thiên thạch mang virus rơi xuống sở thú, biến các con vật thành Zombie kẹo dẻo. Cô sói Gracie và chú sư tử núi Dan đã hợp sức với nhóm bạn thú tìm cách cứu lấy sở thú. Cuối cùng, họ phát hiện ra âm nhạc chính là phương thuốc diệt virus hiệu quả nhất. Nhờ vậy, họ đã đẩy lùi được virus và đưa mọi thứ trở lại bình thường."
    },
];
